...
from .models import (
    ...
    User, Comment, Tag, Like, Rating, University_info, Post_category, Post, Comments, Livestream_info, Questions, Falcuty, Major, Slider
)
from .serializers import (
    CategorySerializer, CourseSerializer,
    LessonSerializer, LessonDetailSerializer,
    UserSerializer, CommentSerializer, UniversitySerializer, PostCategorySerializer, PostSerializer, CommentsSerializer, LivestreamSerializer, QuestionsSerializer, FalcutySerializer, MajorSerializer, SliderSerializer
)
